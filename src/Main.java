...
//    private static final String PAGE_ID = "Fiiitd-748364828680463";
            ...
            if (task.getFeedback() == -2) {
                ...
                for (Comment comment : comments.getData()) {
                    ...
                    if (mesg.equals("DONE")
                        ...
                        if(Utilities.isValidTimeDiff(task.getTimestamp(), new Timestamp(comment.getCreatedTime().getTime()), TIME_MARGIN))
